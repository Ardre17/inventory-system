    ...
    <div style="max-width:900px; margin:0 auto;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem;">
            ...
            <a href="{{ route('orders.import.form') }}"
               style="background-color:#059669; color:white; padding:0.5rem 1rem; border-radius:0.5rem; font-weight:600; text-decoration:none;">
                📂 Importar CSV
            </a>
        </div>
        ...
        <div style="background:white; border-radius:0.75rem; box-shadow:0 1px 4px rgba(0,0,0,0.1); padding:1rem; margin-bottom:1rem;">
            <form method="GET" action="{{ route('orders.index') }}">
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr 1fr auto auto; gap:0.75rem; align-items:end;">
                    ...
                    <button type="submit"
                            style="background-color:#7c3aed; color:white; padding:0.5rem 1.25rem; border-radius:0.5rem; font-weight:600; border:none; cursor:pointer; white-space:nowrap;">
                        Filtrar
                    </button>
                ...
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <div style="display:flex; gap:0.5rem;">
                        ...
                        <form action="{{ route('orders.destroy', $order) }}" method="POST"
                            ...
                            @csrf @method('DELETE')
                            <button style="background-color:#ef4444; color:white; padding:0.25rem 0.75rem; border-radius:0.375rem; font-size:0.875rem; border:none; cursor:pointer;">
                                🗑️
                            </button>
                        </form>
                    </div>
